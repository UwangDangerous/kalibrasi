<div class="card p-3">
    <form action="" method="post">
        ...
        <input type="text" name="nama_unit" id="nama_unit" class='form-control mb-3' value='<?= $unit['nama_unit'];?>' autofocus autocomplete="off">
        ...
        <input type="text" name="nama_lain" id="nama_lain" class='form-control mb-3' value='<?= $unit['nama_lain'];?>' autocomplete="off">
