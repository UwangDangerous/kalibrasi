                ...
                <?php foreach ($lab as $row) : ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?= base_url(); ?>admin/lab/hapus/<?= $row['id_lab']; ?>" data-toggle='tooltip' title='Hapus Data' class="badge badge-danger"><i class="fa fa-trash" onclick="return confirm('Yakin Hapus?');"></i></a>
                        </td>
                    </tr>
                <?php endforeach ; ?>
            </tbody>
