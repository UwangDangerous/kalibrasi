    ...
    <form action="" method="post">
        <div class="row">
            <div class="col-md-6 mb-2">
                ...
                <input type="text" name="nama_admin" id="nama_admin" class='form-control mb-3' value='<?= $admin['nama_admin'] ;?>' autofocus autocomplete="off">
            ...
            <div class="col-md-6 mb-2">
                ...
                <select name="id_unit" id="id_unit" class="form-control">
                    ...
                    <?php foreach ($unit as $u) : ?>
                        <?php if( $admin['id_unit'] == $u['id_unit'] ) : ?>
            ...
            <div class="col-md-12 mb-2">
                ...
                <textarea name="alamat" id="alamat" cols="30" rows="3" class="form-control"><?= $admin['alamat']; ?></textarea>
                <small id="usernameHelp" class="form-text text-danger"><?= form_error('alamat'); ?></small>
            ...
            <div class="col-md-6 mb-2">
                ...
                <select name="id_prov" id="id_prov" class="form-control">
                    ...
                    <?php foreach ($prov as $p) : ?>
                        <?php if( $admin['id_prov'] == $p['id_prov'] ) : ?>
            ...
            <div class="col-md-6 mb-2">
                ...
                <select name="id_kota" id="id_kota" class="form-control">
                    ...
                    <?php foreach ($kota as $k) : ?>
                        <?php if( $admin['id_kota'] == $k['id_kota'] ) : ?>
            ...
            <div class="col-md-6 mb-2">
                ...
                <input type="text" name="nama_kepala" id="nama_kepala" class='form-control mb-3' value='<?= $admin['nama_kepala'] ;?>' autocomplete="off">
            ...
            <div class="col-md-6 mb-2">
                ...
                <input type="text" name="nama_pj" id="nama_pj" class='form-control mb-3' value='<?= $admin['nama_pj'] ;?>' autocomplete="off">
            ...
            <div class="col-md-4 mb-2">
                ...
                <input type="text" name="telp_pj" id="telp_pj" class='form-control mb-3' value='<?= $admin['telp_pj'] ;?>' autocomplete="off">
            ...
            <div class="col-md-4 mb-2">
                ...
                <input type="email" name="email" id="email" class='form-control mb-3' value='<?= $admin['email'] ;?>' autocomplete="off">
            ...
            <div class="col-md-4 mb-2">
                ...
                <input type="text" name="username" id="username" class='form-control mb-3' value='<?= $admin['username'] ;?>' autocomplete="off">
